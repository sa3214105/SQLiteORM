...
TEST_F(SQLiteHelperTest, ConstraintPrimaryKey) {
    using IdColumn = Column<"id", column_type::INTEGER, PrimaryKey<>>;
...
TEST_F(SQLiteHelperTest, ConstraintPrimaryKeyDesc) {
    using IdColumn = Column<"id", column_type::INTEGER, PrimaryKey<OrderType::DESC>>;
...
TEST_F(SQLiteHelperTest, ConstraintNotNull) {
    using EmailColumn = Column<"email", column_type::TEXT, NotNull<>>;
...
TEST_F(SQLiteHelperTest, ConstraintUnique) {
    using UsernameColumn = Column<"username", column_type::TEXT, Unique<>>;
...
TEST_F(SQLiteHelperTest, ConstraintCombinationPrimaryKeyNotNull) {
    using IdColumn = Column<"id", column_type::INTEGER, PrimaryKey<>, NotNull<>>;
...
TEST_F(SQLiteHelperTest, ConstraintCombinationUniqueNotNull) {
    using EmailColumn = Column<"email", column_type::TEXT, Unique<>, NotNull<>>;
...
TEST_F(SQLiteHelperTest, ConstraintPrimaryKeyConflictReplace) {
    using IdColumn = Column<"id", column_type::INTEGER, PrimaryKey<OrderType::ASC, ConflictCause::REPLACE>>;
...
TEST_F(SQLiteHelperTest, ConstraintUniqueConflictIgnore) {
    using EmailColumn = Column<"email", column_type::TEXT, Unique<ConflictCause::IGNORE>>;
...
TEST_F(SQLiteHelperTest, ConstraintNotNullConflictFail) {
    using RequiredColumn = Column<"required_field", column_type::TEXT, NotNull<ConflictCause::FAIL>>;
